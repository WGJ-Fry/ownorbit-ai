...
test("production build serves desktop admin, mobile PWA, manifest, and service worker", async (t) => {
  ...
  assert.match(translationsSource, /手机刚打开过旧入口/);
  assert.match(translationsSource, /刷新 iCloud 手机入口，并重新生成绑定二维码/);
  ...
  assert.match(translationsSource, /Phone just opened an old entry/);
  assert.match(translationsSource, /refresh the iCloud mobile entry and generate a fresh pairing QR/);
