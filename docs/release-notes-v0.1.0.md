...
> [!WARNING]
> `v0.1.0` is superseded by [`v0.1.3-alpha`](https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.3-alpha). It is kept only as an earlier alpha record and should be marked as prerelease on GitHub so it does not appear as the recommended Latest release.
>
> `v0.1.0` 已被 [`v0.1.3-alpha`](https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.3-alpha) 取代。它只应作为早期 alpha 记录保留，并应在 GitHub 上标记为 prerelease，避免误导用户下载旧版本。
