...
1. 选择 provider：DeepSeek、通义千问/DashScope（支持 Qwen3.7-Max）、Kimi、智谱 GLM、千帆/文心、腾讯混元、豆包、MiniMax、StepFun、硅基流动、百川、OpenAI、Gemini、Claude、Mistral、Groq、Perplexity、Together、xAI、OpenRouter 或本地模型都可以。
...
1. Pick a provider: DeepSeek, Qwen/DashScope (including Qwen3.7-Max), Kimi, GLM, Qianfan/ERNIE, Hunyuan, Doubao, MiniMax, StepFun, SiliconFlow, Baichuan, OpenAI, Gemini, Claude, Mistral, Groq, Perplexity, Together, xAI, OpenRouter, or a local model.
