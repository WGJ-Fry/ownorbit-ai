...
- macOS Developer ID signing/notarization and Windows Authenticode signing are not included in this candidate.
...
- 当前候选版不包含 macOS Developer ID 签名/公证，也不包含 Windows Authenticode 签名。
