...
| 平台 | 文件 | 状态 |
| --- | --- | --- |
| macOS Apple Silicon | `release/LifeOS AI-0.0.0-arm64.dmg` | 支持 Developer ID 签名 + Apple 公证发布；未签名构建会触发 Gatekeeper 提示 |
...
| --- | --- | --- |
| macOS Apple Silicon | `release/LifeOS AI-0.0.0-arm64.dmg` | Supports a signed + notarized release path; unsigned local builds can still hit Gatekeeper |
