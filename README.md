...
- iCloud currently syncs only mobile entry files. Chat history, memory, tasks, device credentials, SQLite data, AI keys, and generated app state do not sync through iCloud; real iCloud data sync would require CloudKit / iCloud Container and native Apple clients. See [iCloud data sync design boundary](docs/icloud-data-sync-design.md).
