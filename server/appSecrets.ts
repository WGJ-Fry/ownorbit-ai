...
export const aiProviders = [
  ...
  },
  {
    ...
    models: ["qwen-plus", "qwen-max", "qwen-turbo", "qwen-long", "qwen3.7-max", "qwen3.7-plus", "qwen3.7-coder", "qwen3.7-omni-flash", "qwen3-max", "qwen3-plus", "qwen3-coder-plus", "qwen3-coder-flash", "qwen2.5-plus", "qwen2.5-max", "qwen-vl-max", "qwq-plus"],
  },
  {
    id: "moonshot",
